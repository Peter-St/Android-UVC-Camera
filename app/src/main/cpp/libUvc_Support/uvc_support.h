...
#include "../libuvc/include/libuvc/libuvc.h"
#include "UVC_Camera_Saki/localdefines.h"


// UVC Camera Struct (Access from C and C++) (JNA and JNI)
...
extern int fetchTheCamStreamingEndpointAdress (uvc_camera_t *uvc_camera, int FD);
